      ...
      {isMounted ? (
        <header className=" relative uppercase h-[100svh]">
          <div className="flex  flex-col justify-center w-full z-10 h-full items-center absolute">
            ...
            {!videoIsPlaying && (
              <div ref={playButtonRef} className="flex justify-center w-full ">
          ...
          <div className="flex justify-center items-center h-full">
            <div className="relative aspect-[9/16] h-[80%] max-w-[40rem] flex justify-center items-center">
              <div
              ...
              <video
                ...
                autoPlay
                loop
                className="w-full h-full object-cover aspect-[9/16] rounded-[2rem] absolute opacity-70 hover:cursor-pointer    "
                preload="auto"
              />
              <div
                ref={videoTextRef}
