    ...
    <main className="flex flex-col gap-60">
        ...
        <div className="grid w-full max-w-[120rem] grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute bottom-5 left-5 font-semibold lg:hidden">
                Spec AD
              </div>
            </div>
          ...
          <div className="relative">
            ...
            />
            <div className="absolute bottom-5 left-5 hidden font-semibold lg:block">
              Spec AD
            </div>
          </div>
        </div>
      ...
      <section className="relative flex flex-col items-center gap-6 overflow-hidden">
        ...
        <p className="lg:text-balance max-w-4xl px-6 text-center font-semibold sm:text-2xl">
          Adam Lindsköld är en filmskapare och fotograf från Umeå. Så länge han
          kan minnas har han varit engagerad i foto samt digitalt skapande och
          har producerat en mängd olika projekt med främst fokus på reklamfilm
          och produktfoto.
        </p>
        <Link href="/om-mig">
